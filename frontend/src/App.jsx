...
function App() {
  ...
  const handleUpdate = async (id) => {
    try {
      ...
      console.log("error fetch on updating", error);
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      console.log("error fetch on deleting", error);
    }
  };
  ...
  const handleToggle = async (id)=>{
    try {
      ...
      console.log("Error found in toggle", error);
    }
  }
                    ...
                    <div className="flex items-center gap-x-3">
                      ...
                      <div className="flex gap-x-2">
                        <button
                          ...
                          rounded-lg hover:bg-green-600 cursor-pointer"
